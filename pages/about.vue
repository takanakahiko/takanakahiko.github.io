  ...
  <div>
    ...
    <section class="section">
      <div class="container">
        ...
        <div class="columns is-variable">
          ...
          >
            <p>
              <span class="icon"><i :class="`mdi mdi-${item.icon} mdi-48px`"></i></span>
            </p>
            <p class="title is-4">
              {{ item.title }}
            </p>
    ...
    <section class="section">
      <div class="container has-text-centered">
        ...
        >
          <span class="icon is-large"><i :class="`mdi mdi-${linkInfo.icon} mdi-48px`"></i></span>
        </a>
      </div>
    </section>
  </div>
    ...
    return {
      likes: [
        ...
        },
        {
          icon: 'earth',
          title: 'OSS',
          comment: 'I like those cultures.',
          body: 'Clasp / Nuxt / saojs / ...'
        },
        {
          icon: 'television-classic',
          title: 'Animes',
          comment: 'I like girls who strive hard.',
          body: 'Pripara / Aikatsu! / Vividred Operation / ...'
        }
      ],
      links: [
        {
